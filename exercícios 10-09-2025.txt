...
RESPOSTA: Letra 'a' - Abstract Window Toolkit
...
RESPOSTA: letra 'b' - Swing é baseado em AWT, mas é mais leve e personalizável
...
RESPOSTA: letra 'b' - A ação de clicar no botão e fechar
...
RESPOSTA: letra 'a'- Um container de elementos gráficos (janela principal)
...
RESPOSTA: letra 'b' - Definir a estrutura e os elementos exibidos no Stage
...
RESPOSTA: letra 'a' - start(Stage primaryStage)
...
RESPOSTA: letra 'b' - javafx.scene.control
